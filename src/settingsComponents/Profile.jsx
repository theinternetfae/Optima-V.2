        ...
        <div className="sett-body">
            ...
            <div className="user-preferences">
                ...
                <div className="preference">
                    ...
                    <div className={`toggle ${quirkState && "bg-accentmain"}`} onClick={() => setQuirkState(prev => !prev)}>
                ...
                <div className="preference">
                    ...
                    <div className={`toggle ${quoteState && "bg-accentmain"}`} onClick={() => setQuoteState(prev => !prev)}>
                ...
                <div className="preference">
                    ...
                    <div className={`toggle ${streakState && "bg-accentmain"}`} onClick={() => setStreakState(prev => !prev)}>
